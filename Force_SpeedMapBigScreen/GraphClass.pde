...
/*   =================================================================================       
    ...
    class Graph 
    {
      ...
      float   yMax=1024.00, yMin=0.00;      // Default axis dimensions
      float   T=0.09;                 //Sample Period
      float   xMax=0, xMin=-T*xDiv;
      float   yMaxRight=1024.00,yMinRight=0.00;
  ...
  //    int Peakcounter=0,nPeakcounter=0;
   ...
   /*  =========================================================================================
       ...
       ==========================================================================================  */
        ...
        fill(BackgroundColor); color(0);stroke(StrokeColor);strokeWeight(2);
        int t=60;
        
        rect(xPos-t*1.6,yPos-t,Width+t*2.5,Height+t*2,Height/7);            // outline
        ...
        textSize(10); noFill(); stroke(255); smooth();strokeWeight(1);
          ...
          if(RightAxis){                                       // Right-axis line   
           ...
           for(int x=0; x<=xDiv; x++){
            ...
            String xAxis=nf(xMin+float(x)/xDiv*(xMax-xMin), 0, 2);
          ...
          for(int y=0; y<=yDiv; y++){
            ...
            textAlign(RIGHT);fill(200);
            
            //String yAxis=str(yMin+float(y)/yDiv*(yMax-yMin));     // Make y Label a string
            String yAxis=nf(yMin+float(y)/yDiv*(yMax-yMin), 0, 2);
            ...
            if(RightAxis){
              ...
              color(GraphColor); stroke(GraphColor);fill(200);
